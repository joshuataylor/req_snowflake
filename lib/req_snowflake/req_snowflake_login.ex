defmodule ReqSnowflakeLogin do
  ...
  @allowed_options ~w(username password account_name region warehouse role database schema query_tag rows_per_resultset statement_timeout_in_seconds application_name session_parameters)a
